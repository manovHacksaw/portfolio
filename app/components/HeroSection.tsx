...
export default function HeroSection({ personalInfo, portfolioLinks }: HeroSectionProps) {
  ...
  return (
    <section className="w-full bg-[var(--background)] px-5 flex flex-row items-start justify-between gap-6 sm:gap-8 py-8">
      ...
      <div className="flex flex-col justify-between flex-1 h-32 sm:h-36 md:h-40 lg:h-44">
        ...
        {/* SEEKING Section */}
          {/* <div className="flex flex-col gap-1.5 mt-1.5 p-3 border border-[var(--foreground)] rounded-lg w-fit">
            <p className="text-[9px] uppercase tracking-wider text-[var(--foreground)] font-light">
              SEEKING
            </p>
