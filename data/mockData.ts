  ...
  hackathons: [
    {
      ...
      achievement: 'Anon Aadhar Track Prize',
      date: 'Aug 2024',
      description: 'Built Reeve Reviews - A decentralized review platform for businesses and products. Users can review businesses and products and earn rewards for their reviews.',
      imageUrl: '/projects/edu-legacy.png',
      projectUrl: 'https://edu-legacy.vercel.app',
      prize: '$50',
      announcementUrl: "https://www.facebook.com/share/p/Qe8F6NV9NW9RkvEm/?mibextid=qi2Omg"
    },
    {
      id: '2',
      name: 'Celo ReFi Hackathon',
      achievement: 'Winner',
      date: 'Oct 2025',
      description: 'Built Mizu Pay - A decentralized checkout platform enabling real-world purchases with Celo stablecoins. Integrated ReFi climate project contributions with every transaction. Developed browser extension for seamless e-commerce integration.',
    ...
    },
    {
      ...
      achievement: 'Winner',
      date: 'Jan 2025',
      description: 'Built GrassDotFun - A comprehensive betting game platform with 5+ mini games. Implemented NEAR intents for cross-chain withdrawals. Integrated GolemDB for decentralized data management.',
      imageUrl: '/projects/grassdotfun.png',
      projectUrl: '#',
    },
    {
      id: '4',
      name: 'Polygon Build-A-Thon',
      achievement: 'Winner',
      date: 'Jan 2025',
      description: 'Built PolyTix - A decentralized voting dApp supporting token-gated, open, and registration-based campaigns. Implemented NFT-based access control for voters and candidates. Integrated The Graph protocol for efficient on-chain data indexing.',
      imageUrl: '/projects/polytix.png',
      projectUrl: 'https://polytix.vercel.app',
    },
  ],
  skills: [
