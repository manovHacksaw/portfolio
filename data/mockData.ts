  ...
  projects: [
    {
      ...
      longDescription: 'Built a decentralized checkout platform enabling real-world purchases using Celo stablecoins (cUSD, CELO). Developed on-chain payment verification with Envio indexing and a Next.js DApp integrated via browser extension. Won 2nd Prize at the Build On Celo Hackathon by Rise In — Kolkata among 100+ participants.',
      imageUrl: '/projects/mizu-pay.jpg',
    ...
    },
    {
      ...
      longDescription: 'Built a full-stack finance tracker with budgeting, AI receipt parsing, and CSV/PDF exports. Added recurring transactions via Inngest and real-time balance sync across accounts. Implemented currency selection, Clerk auth, and Arcjet bot protection. Used Gemini AI to extract data from receipts and generate spending insights.',
    ...
    },
    {
      ...
      longDescription: 'Built a decentralized voting dApp supporting token-gated, open, and registration-based campaigns. Secured voting via NFT-based access for voters and candidates. Used The Graph to index campaigns and voting data for efficient querying, with live on-chain results.',
    ...
    },
    {
      ...
      longDescription: 'Decentralized Smart Will system for programmable asset and scholarship inheritance. Integrated inactivity and milestone-based unlocks with signature verification. Won over $10,000 in hackathon bounties and accepted into the Open Campus Incubator.',
