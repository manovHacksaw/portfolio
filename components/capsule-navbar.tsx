...
export default function FloatingNavbar({ activeSection, onNavigate, theme, toggleTheme }: FloatingNavbarProps) {
  ...
  return (
    ...
    `}>
      ...
      `}>
        ...
        >
          {theme === 'dark' ? (
            <Sun size={18} className="transition-transform duration-200 group-hover:scale-110 group-hover:rotate-12" />
          ) : (
