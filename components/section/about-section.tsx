    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2
            className={`font-space-grotesk text-3xl md:text-4xl font-bold mb-6 transition-colors duration-300 ${
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p
              className={`font-fira-sans leading-relaxed transition-colors duration-300 ${
            ...
            >
              Currently exploring the fascinating world of blockchain
              technology, particularly Solana development, while maintaining a
          ...
          <div className="space-y-8">
            ...
            >
              <h3
                className={`font-poppins text-lg font-semibold mb-4 transition-colors duration-300 ${
                  theme === "dark" ? "text-white" : "text-gray-900"
                }`}
              >
                Technologies I Love
            ...
            >
              ...
              <ul
                className={`font-fira-sans space-y-2 transition-colors duration-300 ${
                  theme === "dark" ? "text-gray-300" : "text-gray-600"
                }`}
              >
